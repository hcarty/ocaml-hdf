...
(* OASIS_START *)
(* DO NOT EDIT (digest: 190b3f826a227cf9a80868d511d64f04) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/hcarty/ocaml-hdf";
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/hcarty/ocaml-hdf.git";
                      src_repo_browser =
                        Some "https://github.com/hcarty/ocaml-hdf";
     ...
     oasis_version = "0.4.1";
     oasis_digest = Some "\221U\191\153\196\137]\187\127\191oe\127\028N\134";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
