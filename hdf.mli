type 'a try_t = Result of 'a | Error of exn
val try_finally : 'a -> ('a -> 'b) -> ('a -> 'c) -> 'c
val unless : exn -> ('a -> 'b) -> 'a -> 'b option
val ( |? ) : 'a option -> 'a -> 'a
...
module Make :
  functor (Layout : HDF4_LAYOUT_TYPE) ->
    sig
      ...
      external sd_getdimstrs :
        int32 -> intn -> intn * string * string * string
      ...
      external vs_write :
        int32 ->
        ('a, 'b, Layout.t) Batteries.Bigarray.Genarray.t ->
      ...
      external sd_writedata :
        int32 -> ('a, 'b, Layout.t) Batteries.Bigarray.Genarray.t -> unit
        = "ml_SDwritedata"
      external sd_readdata :
        int32 ->
        int32 array ->
        int32 array ->
        ('a, 'b, Layout.t) Batteries.Bigarray.Genarray.t -> unit
        = "ml_SDreaddata"
      ...
      module SD :
        sig
          val select :
            ?name:string -> ?index:int32 -> Hdf4.interface -> int32
            ...
            sig
              type ('a, 'b) kind_t = {
                read_data :
                  ...
                  Hdf4.interface -> ('a, 'b, Layout.t) ExtBigarray.Genarray.t;
                write_data :
                  ('a, 'b, Layout.t) ExtBigarray.Genarray.t -> int32 -> unit;
                read_fill : int32 -> 'a;
              ...
              val hdf_float32 :
                (float, Batteries.Bigarray.float32_elt) kind_t
              val hdf_float64 :
                (float, Batteries.Bigarray.float64_elt) kind_t
              val hdf_int8 : (int, Batteries.Bigarray.int8_signed_elt) kind_t
              val hdf_uint8 :
                (int, Batteries.Bigarray.int8_unsigned_elt) kind_t
              val hdf_int16 :
                (int, Batteries.Bigarray.int16_signed_elt) kind_t
              val hdf_uint16 :
                (int, Batteries.Bigarray.int16_unsigned_elt) kind_t
              val hdf_int32 : (int32, Batteries.Bigarray.int32_elt) kind_t
              val wrap_sds_call :
                (int32 -> 'a) ->
                ?name:string -> ?index:int32 -> Hdf4.interface -> 'a
              type ('a, 'b) data_t = {
                name : string;
                data : ('a, 'b, Layout.t) ExtBigarray.Genarray.t;
                attributes : Attribute.t array;
                fill : 'a option;
                kind : ('a, 'b) kind_t;
              }
...
module C :
  sig
    ...
    type hdf_vdata_interlace_t =
      Make(C_layout).hdf_vdata_interlace_t =
        HDF_NO_INTERLACE
      | HDF_FULL_INTERLACE
    external vs_write :
      int32 ->
      ('a, 'b, C_layout.t) Batteries.Bigarray.Genarray.t ->
      int32 -> hdf_vdata_interlace_t -> unit = "ml_VSwrite"
    external vs_read :
      int32 ->
      ('a, 'b, C_layout.t) Batteries.Bigarray.Genarray.t ->
      int32 -> hdf_vdata_interlace_t -> unit = "ml_VSread"
    external sd_writedata :
      int32 -> ('a, 'b, C_layout.t) Batteries.Bigarray.Genarray.t -> unit
      = "ml_SDwritedata"
    external sd_readdata :
      int32 ->
      int32 array ->
      int32 array ->
      ('a, 'b, C_layout.t) Batteries.Bigarray.Genarray.t -> unit
      = "ml_SDreaddata"
    external sd_readattr :
      int32 ->
      int32 -> ('a, 'b, C_layout.t) Batteries.Bigarray.Genarray.t -> unit
    ...
    module SD :
      sig
        ...
        module Generic :
          sig
            val wrap_sds_call :
              ...
              ?name:string -> ?index:int32 -> Hdf4.interface -> 'a
            type fill_value_t =
              Make(C_layout).SD.Generic.fill_value_t =
                Int_fill of int
              | Float_fill of float
              | Int32_fill of int32
            val read_fill :
        ...
        module Strict :
          sig
            type ('a, 'b) kind_t =
              ('a, 'b) Make(C_layout).SD.Strict.kind_t = {
              read_data :
                ?name:string ->
                ?index:int32 ->
                Hdf4.interface -> ('a, 'b, C_layout.t) ExtBigarray.Genarray.t;
              write_data :
                ('a, 'b, C_layout.t) ExtBigarray.Genarray.t -> int32 -> unit;
              read_fill : int32 -> 'a;
              write_fill : int32 -> 'a -> unit;
              data_type : Hdf4.data_t;
            }
            val sd_read_data :
              ...
              Hdf4.interface -> ('a, 'b, C_layout.t) ExtBigarray.Genarray.t
            val sd_write_data : Hdf4.t -> int32 -> unit
            val hdf_float32 : (float, Batteries.Bigarray.float32_elt) kind_t
            val hdf_float64 : (float, Batteries.Bigarray.float64_elt) kind_t
            val hdf_int8 : (int, Batteries.Bigarray.int8_signed_elt) kind_t
            val hdf_uint8 :
              (int, Batteries.Bigarray.int8_unsigned_elt) kind_t
            val hdf_int16 : (int, Batteries.Bigarray.int16_signed_elt) kind_t
            val hdf_uint16 :
              (int, Batteries.Bigarray.int16_unsigned_elt) kind_t
            val hdf_int32 : (int32, Batteries.Bigarray.int32_elt) kind_t
            val wrap_sds_call :
              ...
              ?name:string -> ?index:int32 -> Hdf4.interface -> 'a
            type ('a, 'b) data_t =
              ('a, 'b) Make(C_layout).SD.Strict.data_t = {
              name : string;
              data : ('a, 'b, C_layout.t) ExtBigarray.Genarray.t;
              attributes : Attribute.t array;
              fill : 'a option;
              kind : ('a, 'b) kind_t;
            }
...
module Fortran :
  sig
    ...
    val he_clear : unit -> unit
    type hdf_vdata_interlace_t =
      Make(Fortran_layout).hdf_vdata_interlace_t =
        HDF_NO_INTERLACE
      | HDF_FULL_INTERLACE
    external vs_write :
      int32 ->
      ('a, 'b, Fortran_layout.t) Batteries.Bigarray.Genarray.t ->
      int32 -> hdf_vdata_interlace_t -> unit = "ml_VSwrite"
    external vs_read :
      int32 ->
      ('a, 'b, Fortran_layout.t) Batteries.Bigarray.Genarray.t ->
    ...
    external sd_writedata :
      int32 ->
      ('a, 'b, Fortran_layout.t) Batteries.Bigarray.Genarray.t -> unit
      = "ml_SDwritedata"
    external sd_readdata :
      int32 ->
      int32 array ->
    ...
    module SD :
      sig
        ...
        module Generic :
          sig
            val wrap_sds_call :
              ...
              ?name:string -> ?index:int32 -> Hdf4.interface -> 'a
            type fill_value_t =
              Make(Fortran_layout).SD.Generic.fill_value_t =
                Int_fill of int
              | Float_fill of float
              | Int32_fill of int32
            val read_fill :
            ...
            val write_fill : int32 -> fill_value_t -> unit
            type t =
              Make(Fortran_layout).SD.Generic.t = {
              name : string;
              data : Hdf4.t;
              attributes : Attribute.t array;
              fill : fill_value_t option;
        ...
        module Strict :
          sig
            type ('a, 'b) kind_t =
              ('a, 'b) Make(Fortran_layout).SD.Strict.kind_t = {
              read_data :
                ?name:string ->
                ?index:int32 ->
                Hdf4.interface ->
                ('a, 'b, Fortran_layout.t) ExtBigarray.Genarray.t;
              write_data :
                ('a, 'b, Fortran_layout.t) ExtBigarray.Genarray.t ->
                int32 -> unit;
              read_fill : int32 -> 'a;
            ...
            val wrap_sds_call :
              ...
              ?name:string -> ?index:int32 -> Hdf4.interface -> 'a
            type ('a, 'b) data_t =
              ('a, 'b) Make(Fortran_layout).SD.Strict.data_t = {
              name : string;
              data : ('a, 'b, Fortran_layout.t) ExtBigarray.Genarray.t;
              attributes : Attribute.t array;
              fill : 'a option;
              kind : ('a, 'b) kind_t;
            }
