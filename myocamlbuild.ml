(* OASIS_START *)
(* DO NOT EDIT (digest: ce256b2dc5ea967e63ca9ae808c77fab) *)
...
# 21 "/home/hcarty/.odb/install-oasis/oasis-0.2.1~alpha1/src/plugins/ocamlbuild/MyOCamlbuildFindlib.ml"
...
# 21 "/home/hcarty/.odb/install-oasis/oasis-0.2.1~alpha1/src/plugins/ocamlbuild/MyOCamlbuildBase.ml"
...
# 55 "/home/hcarty/.odb/install-oasis/oasis-0.2.1~alpha1/src/plugins/ocamlbuild/MyOCamlbuildBase.ml"
...
let package_default =
  {
     MyOCamlbuildBase.lib_ocaml = [("src/hdf", ["src"])];
     lib_c = [("hdf", "src", ["src/camlidlruntime.h"; "src/hdf_wrapper.h"])];
     flags = [];
     }
  ;;
